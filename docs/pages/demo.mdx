...
> For a full experience, you may want to try it locally:
...
- other:
  ...
  - check if the `hello` command logs the arguments passed to it on the console
  - check if a nested command option works (e.g., `hello -h`), and see that an option can have no name
