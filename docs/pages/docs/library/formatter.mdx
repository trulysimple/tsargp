...
The help message is a string that may contain control sequences and can be printed on a terminal
that supports sequences. There are two methods to obtain help messages:
...
These phrases will be formatted according to the [text formatting](styles.mdx#text-splitting) rules.
