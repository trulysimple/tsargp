...
The `format` attribute, if present, specifies the [help format](formatter.mdx#help-format). The
`headingStyle` attribute, if present, specifies a [style](styles.mdx#style) to be applied to group
headings.
