...
The `termWidth` property is the desired terminal width in which to print the help message (in number
of columns). This value is passed directly to the constructor of the [formatter](formatter.mdx)
class, when processing a help option.
