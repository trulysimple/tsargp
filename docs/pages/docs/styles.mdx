...
The `style` function creates a style from a list of styling attributes. The result can be used in
any part of the API that expects the `Style` type, or it can be embedded directly in text
