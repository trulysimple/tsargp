...
- **inline** - allows (or requires) parameters to be inlined with an option name
...
<Callout type="default">
  This attribute can be safely omitted, which is useful if the option can be specified through
  either [positional] arguments, standard [input] or environment [data sources].
</Callout>
