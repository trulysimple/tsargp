...
options that will appear in the help message. The filter matches options' names, synopsis and
environment variable name. If multiple patterns are provided, any matched one will suffice to
