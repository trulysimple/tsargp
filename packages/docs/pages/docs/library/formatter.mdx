...
- `progName` - the name of the program to display in usage sections
...
- `descrAbsolute` - whether the indentation level for the option description should be relative to
  the beginning of the line instead of the end of the option parameter (defaults to `false{:ts}`)
