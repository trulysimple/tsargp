...
- `invalidRequiredValue`- `'Option %o has invalid required value. Option is always required or has a default value.'{:ts}`
- `incompatibleRequiredValue` - `'Option %o has incompatible required value %v. Should be of type %s.'{:ts}`
