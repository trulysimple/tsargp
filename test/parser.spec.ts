  ...
  describe('parse', () => {
    ...
    describe('number', () => {
      ...
      it('should handle a number option with custom parsing', () => {
        ...
        const parser = new ArgumentParser(options);
        expect(parser.parse(['-n', '1'])).toMatchObject({ number: 3 });
      });
    ...
    describe('strings', () => {
      ...
      it('should handle a strings option with custom parsing', () => {
        ...
        const parser = new ArgumentParser(options);
        expect(parser.parse(['-ss', '1,2|2'])).toMatchObject({ strings: ['1', '2'] });
      });
    });
    ...
    describe('numbers', () => {
      ...
      it('should handle a numbers option with custom parsing', () => {
        ...
        const parser = new ArgumentParser(options);
        expect(parser.parse(['-ns', '1,2|2'])).toMatchObject({ numbers: [1, 2] });
      });
