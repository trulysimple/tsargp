...
describe('TerminalString', () => {
  ...
  describe('addAndRevert', () => {
    it('should add text with surrounding sequences', () => {
      const str = new TerminalString();
      str.addAndRevert(style(tf.clear, fg8(0), bg8(0), ul8(0)), 'type', edit(1, ed.dch));
      expect(str).toHaveLength(4);
      expect(str.strings).toHaveLength(1);
      expect(str.strings[0]).toEqual('\x9b0;38;5;0;48;5;0;58;5;0m' + 'type' + '\x9b1P');
    });
  });
